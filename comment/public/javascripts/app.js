...
var app = new Vue({
  ...
  methods: {
    async getall() {
      console.log("get all");
      var url = "http://cs260.cbuford.com:8080/comments"; // This is the route we set up in index.js
      try {
    ...
    addComment() {
      var url = "http://cs260.cbuford.com:8080/comments";
      axios.post(url, {
    ...
    incrementUpvotes(item) {
      var url = "http://cs260.cbuford.com:8080/comments/"+item._id+"/upvote";
      axios.put(url)
          .then(response => {
